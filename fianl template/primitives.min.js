/*
 Basic Primitives Diagram v3.6.4
...
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n,r,s,v=e/2,u=null,y=0,z=0,w=this;r=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){t=a.getIntersectionPoint(r,!0);y=b;return null!=t});d.loopEdges(function(a,b){q=a.getIntersectionPoint(r,!0);z=b;return null!=q});if(null!=t&&null!=q){var A=new primitives.common.Vector(t,q);m.getOffset(A,function(c,d,e){A.offset((c*f-(d-1)*f/2)*e);t=A.from;q=A.to;switch(i){case 1:s=
